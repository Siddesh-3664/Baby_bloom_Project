<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete_vac_record.aspx.cs" Inherits="delete_vac_record" %>
...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w" runat="server">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Username is required">
						<asp:TextBox ID="TextBox1" runat="server"   CssClass="input100" Type="text" placeholder="vaccinerecord_id" required="" ></asp:TextBox>
            ...
            <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn btn-success" NavigateUrl="vaccine_display_doc.aspx">GO_BAck</asp:HyperLink>
			</div>
		</div>
