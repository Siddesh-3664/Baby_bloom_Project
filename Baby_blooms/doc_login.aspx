<%@ Page Language="C#" AutoEventWireup="true" CodeFile="doc_login.aspx.cs" Inherits="doc_login" %>
		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w" runat="server">
					...
					<div class="flex-sb-m w-full p-t-3 p-b-24">
						...
						<div>
							...
							<a href="doc_signup.aspx" class="txt1">
								Signup
							</a>
						</div>
					</div>
				...
				<div class="align-content-center center" style="text-align:center" >
                    ...
                    &nbsp;&nbsp;&nbsp;
                        <br />
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="Enter number for Doc_id" ForeColor="Red" ValidationExpression="[0-9]+"></asp:RegularExpressionValidator>
                    </div>
