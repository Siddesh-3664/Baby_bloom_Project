<%@ Page Language="C#" AutoEventWireup="true" CodeFile="doc_signup.aspx.cs" Inherits="doc_signup" %>
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form id="form1" runat="server">
					...
					<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Button" type="submit" value="Doctor Signup" />


                    <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn btn-warning" NavigateUrl="doc_login.aspx">Sign IN</asp:HyperLink>
				</form>
